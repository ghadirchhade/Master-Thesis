...
# =============================================================================
#  Cluster (CSCS) port of the Colab notebook  E02_2c.ipynb
#
#  E02_2c is the E02_2 pipeline (same strip composition, same offline NMS, same
#  all_gt / held_out evaluation) with THREE changes of its own:
#    1. BIGGER TILES: TILE_SIZE = 1536, OVERLAP = 384 (a 25% overlap).
#       E02_2 used 1000 / 150 and the E02_2b sibling uses 2000 / 800, so E02_2c
#       sits between them: 35 tiles per 8192x5460 image, against E02_2's 70 and
#       E02_2b's 28.
#
#       NOTE ON THE NOTEBOOK: its CELL 3 comments describe TILE_SIZE = 3500 and
#       call the tiles "even bigger" than E02_2b's 2000. The CODE sets 1536/384,
#       which is what actually ran, so that is what this port uses. The prose is
#       stale; the numbers here match the executed configuration.
...
SUPERVISION_HINT = (
    ...
    "have no internet: run './E02_2c_run_sam3.sh download' on a LOGIN node first, "
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="E02_2c - SAM3 exemplar-prompted Rumex detection with 1536/384 tiles "
                    "and an optional global-context pass, cluster port of E02_2c.ipynb.",
    ...
    g.add_argument("--experiment-name", default="E02_2c",
    ...
    g.add_argument("--tile-size", type=int, default=1536,
                   help="TILE_SIZE. E02_2c uses 1536, between E02_2's 1000 and the "
                        "E02_2b sibling's 2000. Still comfortably larger than the "
                        "biggest measured plant.")
    g.add_argument("--overlap", type=int, default=384,
                   help="OVERLAP. E02_2c uses 384 = 25%% of the tile (E02_2 used 150, "
                        "E02_2b uses 800). Larger than the max plant width, so every "
                        "plant is whole in some tile.")
...
def compose_tile_with_exemplars(tile_img: Image.Image, crop_images: Sequence[Image.Image],
    ...
    Input : tile_img    - PIL image of the tile
            crop_images - list of PIL exemplar crops (3 for E02_2c)
...
def main() -> None:
    ...
    if args.evaluate_only:
        ...
        if not _check_pandas():
            print("\nERROR: pandas is required for the evaluation. See "
                  "'Problem B' in E02_2c_HOW_TO_RUN.md.")
            sys.exit(2)
    ...
    print("=" * 92)
    print(f" E02_2c SAM3 EXEMPLAR PIPELINE | experiment={exp} | "
