#!/usr/bin/env python3
# =============================================================================
#  E02_2b_infer_sam3.py
# =============================================================================
#  Cluster (CSCS) port of the Colab notebook  E02_2b.ipynb
#
#  E02_2b is the E02_2 pipeline (same strip composition, same offline NMS, same
...
SUPERVISION_HINT = (
    ...
    "have no internet: run './E02_2b_run_sam3.sh download' on a LOGIN node first, "
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="E02_2b - SAM3 exemplar-prompted Rumex detection with big tiles "
                    "and an optional global-context pass, cluster port of E02_2b.ipynb.",
    ...
    g.add_argument("--experiment-name", default="E02_2b",
    ...
    g.add_argument("--tile-size", type=int, default=2000,
                   help="TILE_SIZE. E02_2b uses 2000 (E02_2 used 1000): comfortably "
                        "larger than the biggest measured plant.")
    g.add_argument("--overlap", type=int, default=800,
                   help="OVERLAP. E02_2b uses 800 (E02_2 used 150): larger than the "
...
def main() -> None:
    ...
    if args.evaluate_only:
        ...
        if not _check_pandas():
            print("\nERROR: pandas is required for the evaluation. See "
                  "'Problem B' in E02_2b_HOW_TO_RUN.md.")
            sys.exit(2)
    ...
    print("=" * 92)
    print(f" E02_2b SAM3 EXEMPLAR PIPELINE | experiment={exp} | "
