...
#  E02_2_infer_sam3.py
# =============================================================================
#  Cluster (CSCS) port of the Colab notebook  E02_2.ipynb
#
...
SUPERVISION_HINT = (
    ...
    "have no internet: run './E02_2_run_sam3.sh download' on a LOGIN node first, "
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="E02_2 - SAM3 exemplar-prompted Rumex detection "
                    "(inference + offline evaluation), cluster port of E02_2.ipynb.",
...
def main() -> None:
    ...
    if args.evaluate_only:
        ...
        if not _check_pandas():
            print("\nERROR: pandas is required for the evaluation. See "
                  "'Problem B' in E02_2_HOW_TO_RUN.md.")
            sys.exit(2)
    ...
    print("=" * 92)
    print(f" E02_2 SAM3 EXEMPLAR PIPELINE | experiment={exp} | "
